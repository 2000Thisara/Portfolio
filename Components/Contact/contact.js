      ...
      <div className="contact-container">
        <div className="contact-cards">
          <div className="contact-card">
            ...
            <p className="card-value">thisarasenadeera2000@gmail.com</p>
          </div>
          ...
          <div className="contact-card">
            ...
            <p className="card-value">+94 77 964 2375</p>
          </div>
        ...
        <div className="social-section">
          ...
          <div className="social-icons">
            <a href="www.linkedin.com/in/thisara-senadeera-404b43299" target="_blank" rel="noopener noreferrer" className="social-icon linkedin">
            ...
            <a href="https://github.com/2000Thisara" target="_blank" rel="noopener noreferrer" className="social-icon github">
              <img src="https://zcoregroup.com/assets/images/blog/GitHub-Apps.png" alt="GitHub" />
            </a>
            <a href="https://wa.me/94779642375" target="_blank" rel="noopener noreferrer" className="social-icon whatsapp">
            ...
            <a href="https://www.instagram.com/thisara_senadeera" target="_blank" rel="noopener noreferrer" className="social-icon instagram">
